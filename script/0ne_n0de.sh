...
##Thuc hien chown cho thu muc database tren ca 2 node
##chuyen primary qua node kia mount roi chown lai
...
crm configure primitive p_fs_data ocf:heartbeat:Filesystem params device="/dev/drbd1" directory="/mnt/webdata" fstype="ext4" op start interval="0s" timeout="40s" op stop interval="0s" timeout="40s" op monitor interval="3s"
